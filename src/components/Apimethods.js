//var url_sub2 = "http://10.195.43.180:7277/api"//api/login
...
module.exports.DELETE_USUARIO = url_sub2 + `/Users/Delete?id=`;//Agregar el id para eliminar
module.exports.AUTH_USUARIO = url_sub2 + `/Users/Auth`;
